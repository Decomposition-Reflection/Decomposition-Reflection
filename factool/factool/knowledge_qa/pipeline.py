...
class knowledge_qa_pipeline(pipeline):
    ...
    async def run_with_tool_live(self, responses):
        ...
        if claims_in_response is None or evidences is None:
            raise ValueError("claims_in_response or evidences is None")
    ...
    async def run_with_tool_api_call(self, prompts, responses):
        ...
        for i in range(num_batches):
            ...
            if claims_in_responses is None or evidences_in_responses is None:
                raise ValueError("claims_in_responses or evidences_in_responses is None")
